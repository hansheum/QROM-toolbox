\section{Basics of Cryptography}\label{sec:basics}
  ...
  \subsection{Security Notions}
    ...
    \subsubsection{Experiments and Advantages.}
      ...
      \begin{definition}[Computational Advantage]
        The computing advantage of an adversary $\adv$ against a primitive
    ...
    \subsubsection{PKE Security.}
      At minimum, a secure PKE scheme should hide the message being encrypted.
