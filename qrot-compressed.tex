\section{The Compressed-Oracle Technique, or: How to Lazy-Sample a QRO}\label{sec:compressed}
  ...
  \subsection{But How Do They Work?}
    ...
    \paragraph{How consistency is maintained.}
      ...
      For simplicity, let's consider the case that $m=1$, and
        ...
        \autoref{sec:defining-cros}, we saw that the first three operations
    ...
    \subsection{Extracting Queries}\label{sec:extracting}
      ...
      \begin{theorem}[Extraction is imperfect]\label{thm:imperfect}
        ...
        Now, let the extractor $\extractor$ simulate the random oracle for
          ...
          \autoref{thm:perfect}, the simulation will be perfect, and
