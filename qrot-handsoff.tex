\section{Hands-Off O2H: A Better O2H Lemma from Compressed Oracles?}
  ...
  As you can see, we still end up with the same, characteristic square root loss 
    ...
    $q_{\RO}$ options to the reduction applying the lemma. (Ambainis et al.\
    already showed a similar result, by splitting their Semi-Classical O2H
    result in two parts: \ldots)

  \hhnote{to-do: complete sentence}
  ...
  \begin{proof}
    ...
    where we set the paramater $\ell$ in the theorem to $1$, since
      ...
      Inserting into the previous inequality then gives us our final bound.
      \begin{align*}
        \advantage{}{}[\distinguisher] &\leq 2 \sqrt{ 2 \cdot \prob{\obsev} } 
