\section{A Better O2H Lemma from Compressed Oracles?}\label{sec:handsoff}
  ...
  \subsection{Re-deriving the Semi-Classical O2H Lemma}
    Next, let's re-derive the Semi-Classical O2H bound by introducing
      ...
      \autoref{fig:semiclassical-oracle}.
    ...
    \begin{figure}[t]
      \centering
      \begin{pchstack}[center]
        \procedure{Oracle $\idealRO(\inputreg, \outputreg : \bitreg, \database)$}{
          ...
          \pclinecomment{2.\ Simulate oracle} \\
          \applyU{\decomp}{\inputreg \concat \database} \\
          \applyU{\Hgate^{\otimes m}}{\outputreg} \\
          \applyU{\entangle}{\inputreg \concat \outputreg \concat \database} \\
          \applyU{\Hgate^{\otimes m}}{\outputreg} \\
      ...
      \caption{
        ...
        oracle (taken from \autoref{def:compressed-ros}). Here, $\bitreg$ is a
