\section{A Better O2H Lemma from Compressed Oracles?}\label{sec:handsoff}
  ...
  \subsection{The Hands-Off O2H Lemma}
    ...
    Whether this result is ``better'' than previous art will
      ...
      are clearly situations where the Resampling Lemmaa, for which the
      ...
      \begin{pchstack}[center]
        \procedure{
          ...
          \pcforeach \ket{y} \pcin\ \outputreg \pcdo \\
            \t \pcif y = \targetout \pcthen \applyU{\Xgate}{\register[B]} \\
          (\inputreg, \outputreg) \gets \idealRO(\inputreg, \outputreg) \\
          \pcreturn \register[B]
        }
  ...
  \subsection{From Onewayness to Indistinguishability with Optimal Tightness}
    ...
    \hhnote{
      ...
      tightly up to the square root. (Then achieve CCA-security and publish at
      TCC.)
    }
  \fi
