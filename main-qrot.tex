...
\begin{document}
  ...
  %\part{The Tools of the Toolbox}\label{part:tools}
    \newcommand{\titleOtoH}{The O2H Lemmas: Programming Quantum Random Oracles}
      \inputsect{qrot-o2h}
  ...
  \addcontentsline{toc}{part}{Part 4. Simulation}
  ...
  \addcontentsline{toc}{part}{Part 5. Extraction}
    \newcommand{\titleCcaRom}{Example 2a: Classical CCA-security from the \U-transform}
      \futuresect{qrot-cca-rom}{\titleCcaRom}
    \newcommand{\titleExtract}{Online Extractability: Learning From Oracle Queries}
  ...
  \addcontentsline{toc}{part}{Part 6. Adaptive Programming}
    \newcommand{\titleDsaRom}{Example 3a: Classical CMA-security from NIZKs}
      \futuresect{qrot-dsa-rom}{\titleDsaRom}
    \newcommand{\titleAdaptive}{Delayed Programming from the Resampling Lemma and Fixed-Permutation O2H}
  ...
  \addcontentsline{toc}{part}{Part 7. Rewinding}
