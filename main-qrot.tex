...
\pcfixhyperref % As per cryptocode documentation, "8.3 Hyperref"
  ...
  \clearpage
  \addcontentsline{toc}{part}{Part 3.\quad Compressed Random Oracles: Quantum Lazy-sampling}
  ...
  \ifdraftversion
    \clearpage
    \addcontentsline{toc}{part}{Part 5.\quad Under the Rug: Proving Quantum Lemmas}
    \input{qrot-proofs}
  \fi
