...
%% Hacks to enable grayed-out ToC entries %%
  \providecommand{\texorpdfstring}[2]{#1}   % no-op if hyperref absent
...
\let\cleardoublepage\clearpage
  ...
  %\part{(Post-)Quantum Difficulties}\label{part:classical}
    ...
    \newcommand{\titleCompressed}{How to Lazy-sample QROs with the Compressed-Oracle Technique}
  ...
  %\part{The Tools of the Toolbox}\label{part:tools}
    \input{qrot-o2h}
    \clearpage
    \input{qrot-utransform} % OW -> IND example
    \clearpage
