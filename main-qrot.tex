...
\newcommand{\khnote}[2][]{\todo[inline,color=violet]{\textbf{Kathrin:} \if!#1! #2 \else (#1)\\ #2\fi}\xspace}
...
\pcfixhyperref % As per cryptocode documentation, "8.3 Hyperref"
  ...
  %\clearpage
  %\addcontentsline{toc}{part}{Part 1.\quad Setting The Stage}
  ...
  %\clearpage
  %\addcontentsline{toc}{part}{Part 2.\quad Main Tools}
  \part{Tools of the Toolbox}
    \input{qrot-o2h}
    \clearpage
  ...
  %\ifdraftversion
  %  \clearpage
  %  \addcontentsline{toc}{part}{Part 3.\quad Sigma Protocols in the Quantum Random Oracle Model}
  %  %\input{...}
  %\fi

  \ifdraftversion
    %\clearpage
    %\addcontentsline{toc}{part}{Part 3.\quad Under the Rug: Proving Quantum Lemmas}
    \part{Under The Rug}
    \input{qrot-proofs}
    \clearpage
  \fi
  ...
  % WIP
  \ifdraftversion
  	\input{qrot-KEMs-and-FO} % <- Kat's collection of stuff on FO
