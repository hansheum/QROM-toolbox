...
\pcfixhyperref % As per cryptocode documentation, "8.3 Hyperref"
  ...
  \part{Classical Security, (Post-)Quantum Difficulties}\label{part:classical}
    \ifdraftversion
      \input{qrot-pke-rom}
      \clearpage
      \input{qrot-dsa-rom}
  ...
  \part{Tools of the Toolbox}\label{part:tools}
    \ifdraftversion
      \input{qrot-o2h}
      \clearpage
    \fi
    ...
    \ifdraftversion
      ...
      \input{qrot-adaptive}
      \clearpage
      \input{qrot-rewind} % maybe leave this for v2
    \fi

  \ifdraftversion
    \part{Under The Rug}\label{part:proofs}
    \input{qrot-proofs} % maybe leave this for v3
    \clearpage
  \fi
  ...
  \ifdraftversion
    ...
    % \input{qrot-ttransform} % let's skip this
    % \clearpage
