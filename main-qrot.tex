...
\let\cleardoublepage\clearpage
  ...
  \input{qrot-preface}
    \clearpage
  \addcontentsline{toc}{part}{Part 1. Classical Security}
  ...
  \addcontentsline{toc}{part}{Part 2. The (Post-)Quantum Realm}
  ...
  \addcontentsline{toc}{part}{Part 3. Tools of the Toolbox}
