...
%% TO-DO: Finalize fix, and move to cryptocodeh
...
\pcfixhyperref % As per cryptocode documentation, "8.3 Hyperref"
  ...
  % Main body
  \input{qrot-introduction}

  \clearpage
  \addcontentsline{toc}{part}{Prelude.\quad The Classical Random Oracle Model}
    \input{qrot-preliminaries}
    \input{qrot-bre}

  \clearpage
  \addcontentsline{toc}{part}{Part 1.\quad Into the Quantum Realm}
    \input{qrot-primer}
    \input{qrot-pseudocode}

  %\part{
  %  Confidentiality in the PQ World: 
  %  %The O2H Lemma and Friends
  %  %O2H and Friends
  %  The Many Faces of One-Way to Hiding
  %}

  \clearpage
  \addcontentsline{toc}{part}{Part 2.\quad Public-Key Encryption in the Quantum Random Oracle Model}
    \input{qrot-definitions}
    \input{qrot-o2h}

  %% Add this in future version.
  %\ifdraftversion
  %  %\part{
  %  %  Authenticity in the PQ World:
  %  %  Rewinding Protocols
  %  %}
  %  \addcontentsline{toc}{part}{Part ?.\quad Rewinding in a Quantum World}

  %  \input{qrot-rewinding}
  %\fi 


  \clearpage
  \addcontentsline{toc}{part}{Part 3.\quad Quantum Lazy-sampling with Compressed Random Oracles}
    \input{qrot-compressed}
  \ifdraftversion
    \input{qrot-consistency}
    \input{qrot-improving-o2h}
    % Add in V2
    % \input{qrot-rewinding-revisited}
  \fi

  \ifdraftversion
    \clearpage
    \addcontentsline{toc}{part}{Part 4.\quad Sigma Protocols in the Quantum Random Oracle Model}
    %\input{...}
  \fi

  \ifdraftversion
    \clearpage
    \addcontentsline{toc}{part}{Part 5.\quad Under the Rug: Proofs of Quantum Lemmas}
    \input{qrot-proofs}
  \fi
