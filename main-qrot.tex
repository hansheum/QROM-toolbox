...
\pcfixhyperref % As per cryptocode documentation, "8.3 Hyperref"
  ...
  \clearpage
  \addcontentsline{toc}{part}{Part 0.\quad Into the (Post-)Quantum World}
    \input{qrot-primer}
  ...
  \clearpage
  \addcontentsline{toc}{part}{Part 1.\quad One-Way to Hiding, or: How to Reprogram a QRO}
    \input{qrot-o2h}
    \input{qrot-bre}
  ...
  \clearpage
  \addcontentsline{toc}{part}{Part 2.\quad The Compressed-Oracle Technique, or: How to Lazy-sample a QRO}
  ...
  \ifdraftversion
    \addcontentsline{toc}{part}{Part 3.\quad Down the Rabbit Hole, or: 
      How to Prove QRO Lemmas}
    \input{qrot-proofs}
  \fi
