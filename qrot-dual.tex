\section{Dual-Alphabet Notation}\label{sec:dual}
  \hhnote{
    ...
    What are the equivalent operations for Hadamard-basis states? Well, we know
      ...
      \begin{multline*}
        \hCZgate \ket{\hat a, \hat b} 
          ...
          = \ket{\hat a} \left( \frac{\ket 0 + (-1)^a(-1)^b \ket 1}{\sqrt 2} \right) \\
          = \ket{\hat a} \left( \frac{\ket 0 + (-1)^{a \xor b} \ket 1}{\sqrt 2} \right)
      ...
      where we have defined the xor between two dual-alphabet strings 
        $\hat a \xor \hat b$ to be the dual-alphabet translation of the
        ...
        more easily seen if we write $\Zgate = \hat{\Xgate}$, in which case
        $\hCZgate$ just becomes $\hat{\unitary[C]}\hat\Xgate$.)

      Going back to multi-qubit states,
