\section{Thinking in Dual Alphabets}\label{sec:dual}
  ...
  \subsection{Demonstration}
    ...
    \subsubsection{The Deutsch--Jozsa Algorithm.}
      ...
      %        \underline{Deutsch$_{\text{H}}(f)$}
  	  %	  		\begin{nicodemus}
      %          \smallskip
      %          \item $\register[AB] \gets \ket{\hat{\bits{0}}, \hat{\bits{1}}}$
      %          \smallskip
      %          \item $\register[B] \xstore f(\register[A])$
      %          \smallskip
      %          \item $a \hobstore \register[A]$
      %          \smallskip
      %          \item $\pcif a = \bits{1} \pcthen$ 
      %            \item \quad \pcreturn Balanced
  	  %	  			\item \pcelse \pcreturn Constant
  	  %	  		\end{nicodemus}
  	  %	  	\end{minipage}
      %      \quad 
  	  %	  	\nicoresetlinenr
  	  %	  	\begin{minipage}[t]{4cm}
      %        \underline{Deutsch$_{\text{C}}(f)$}
  	  %	  		\begin{nicodemus}
      %          \smallskip
      %          \item $\register[AB] \gets \ket{\bits{0}, \bits{1}}$
      %          \smallskip
      %          \item $\register[B] \zstore f(\register[A])$
      %          \smallskip
      %          \item $a \obstore \register[A]$
      %          \smallskip
      %          \item $\pcif a = \bits{1} \pcthen$ 
      %            \item \quad \pcreturn Balanced
  	  %	  			\item \pcelse \pcreturn Constant
      ...
      %  \end{center}
      %  \caption{
      %    Deutsch's algorithm, on the left expressed in the canonical way as an
      %    operation on Hadamard-basis states, with a Hadamard measurement at the
      %    end. On the right is an equivalent implementation operating on
      %    computational-basis states, with a computational-basis measurement at
      %    the end. It is up to the reader to decide which implementation they find
      %    brings greater intuitition.
      %  }
      %\end{figure}
      ...
      \begin{figure}[t]
   	    \begin{center}
  	  	  \fbox{
  	  	  	...
  	  	  	\nicoresetlinenr
  	  	  	\begin{minipage}[t]{4cm}
              \underline{Deutsch--Jozsa$_{\text{H}}(f)$}
  	  	  		\begin{nicodemus}
                \smallskip
            ...
            \quad 
  	  	  	\nicoresetlinenr
  	  	  	\begin{minipage}[t]{4cm}
              \underline{Deutsch--Jozsa$_{\text{C}}(f)$}
  	  	  		\begin{nicodemus}
                \smallskip
