\section{The One-Way to Hiding Toolkit}\label{sec:o2h}
  ...
  \begin{table}[h]
    ...
    \caption{
      ...
      the extraction advantage could be before 
    ...
    \begin{tabular}{ccccccccccc}
      ...
      Classical, find & \Tno & \Tyes & \Tyes & \Tyes & \Tyes & \Tyes &
        ...
        $\nicefrac{1}{\varepsilon} \approx 1$ & \autoref{lemma:cl-find} & \cite{CCS:BelRog93} \\
      Classical, guess & \Tno & \Tyes & \Tyes & \Tyes & \Tyes & \Tyes &
        $\advantage{\dist}{1}[\Dis{}]\leq \qRO \cdot \advantage{\guess}{}[\Ext{}]$
        & $\nicefrac{1}{\varepsilon} \approx \qRO$ & \autoref{lemma:cl-guess} & \cite{CCS:BelRog93} \\
      \midrule
