\section{The One-Way to Hiding Toolkit}\label{sec:o2h}
  ...
  \begin{table}[h]
    ...
    \caption{
      ...
      reprogramming, C $=$ Computationally-hidden (as opposed to
      statistically-hidden) reprogramming, and L $=$ allows Leaking information about
      which point was reprogrammed. $\qRO$ bounds the total number of
      oracle calls, and $\qRP$ bounds the number of reprogrammed points. 
      Most bounds presented here are simplified and/or approximate, ignoring
      constant factors and information-theoretic terms; for the exact statement, see the
    ...
    \begin{tabular}{cccccccccc}
      \toprule
      O2H Variant & Q & M & A & C & L & Bound (simplified) & Tightness & Def. & Ref. \\
      \midrule
      Classical, find & \Tno & \Tyes & \Tyes & \Tyes & \Tyes &
        $\advantage{\dist}{1}[\Dis{}]\leq \advantage{\find}{}[\Ext{}]$ &
        $\nicefrac{1}{\varepsilon} \approx 1$ & \autoref{lemma:cl-find} & \cite{CCS:BelRog93} \\
      Classical, guess & \Tno & \Tyes & \Tyes & \Tyes & \Tyes &
      ...
      \midrule
      Original O2H & \Tyes & \Tno & \Tno & \Tyes & \Tyes &
      ...
      Adaptive O2H & \Tyes & \Tno & \Tyes & \Tyes & \Tyes &
      ...
      Fixed-Perm.\ CARF & \Tyes & \Tyes & \Tyes & \Tyes & \Tno &
