...
\newcommand{\panelEpsGrover}{%
  \begin{tikzpicture}[bitsec]
    ...
    \node[cred,rotate=63.43,anchor=south,font=\scriptsize] at (30,-30) {$q\cdot\epsilon_B$};
    \node[cgreen!55!black,align=center,rotate=63.43,font=\scriptsize] at (15,-30) 
      {construction secure};
    \node[orange!70!black,align=center,font=\footnotesize] at (30,-50)
      %{primitive secure \\ construction broken?};
      {gap};
...
\newcommand{\panelKapGrover}{%
  \begin{tikzpicture}[bitsec]
    ...
    \node[cblue!60!black,rotate=-45,anchor=south,font=\footnotesize] at (30,98) {assumed bit-security};
