...
\newcommand{\panelEpsGrover}{%
  \begin{tikzpicture}[bitsec]
    ...
    \node[cgreen!55!black,align=center,font=\tiny] at (26,-7) 
      {construction secure};
    \node[orange!70!black,align=center,font=\scriptsize] at (17,-67)
      %{primitive secure \\ construction broken?};
      {gap};
    \node[cblue!70!black,align=center,font=\scriptsize] at (35,-120) 
      {attacks on $\Pi$};
  \end{tikzpicture}
}
...
\newcommand{\panelEpsCube}{%
  \begin{tikzpicture}[bitsec]
    ...
    \draw[cblue,very thick] (0,-\n) -- ({\n/3},0);
    \draw[cred,very thick,dashed] (0,{-\n/2}) -- ({\n/3},0);
    \node[cblue,rotate=71.57,anchor=south,font=\scriptsize] at (32,-55) {$\epsilon_\Pi \approx t^3$};
    \node[cred,rotate=56.31,anchor=south,font=\scriptsize] at (16,-38) {$\sqrt{\epsilon_\Pi}$};
    \node[cgreen!55!black,align=center,font=\tiny] at (7,-8) {constr.\\secure};
    \node[orange!70!black,align=center,font=\scriptsize] at (10,-78) {gap};
    \node[cblue!70!black,align=center,font=\tiny,rotate=90] at (38,-95) {primitive broken};
  \end{tikzpicture}
}
...
\newcommand{\panelKapSearch}{%
  \begin{tikzpicture}[bitsec]
    ...
    \node[cgreen!55!black,rotate=35,font=\footnotesize] at (45,68) {implied bit-security};
...
\newcommand{\panelKapGrover}{%
  \begin{tikzpicture}[bitsec]
    ...
    \node[cgreen!55!black,rotate=30,font=\scriptsize] at (28,45) {implied bit-security};
...
\newcommand{\panelKapCube}{%
  \begin{tikzpicture}[bitsec]
    ...
    \draw[cblue,very thick] (0,\n) -- ({\n/3},{\n/3});
    \fill ({\n/3},{\n/3}) circle (1.6pt);
    \node[cblue!60!black,rotate=-63.43,anchor=south,font=\scriptsize] at (14,90) {assumed bit-security};
    \node[orange!70!black,font=\scriptsize] at (9,84) {gap};
    \node[cgreen!55!black,rotate=-26.57,font=\tiny] at (20,40) {implied bit-security};
    \node[black!55,font=\scriptsize] at (32,12) {N/A};
    \node[anchor=west,font=\tiny,gray] at ({\n/3+1},{\n/3}) {128 bits};
  \end{tikzpicture}
}
