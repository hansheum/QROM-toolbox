...
\section{The Random Oracle Model}\label{sec:rom}
    ...
    \paragraph{Guess-O2H.}
      ...
      \begin{exercise}\label{ex:cparom-lossy}
        ...
        \emph{
          ...
          how $\extractor$ works, it is enough that the lemma states that it exists; 
          all that is left for $\bdv$ to do is to provide $\extractor$ with its
  ...
  \subsection{The Post-Quantum Setting -- What Breaks?}
    ...
    This is where the very same O2H formalism that we introduced above earns its
      ...
      This is because they successfully shove the tricky quantum part of the analysis
