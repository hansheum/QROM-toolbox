\section{Select Exercise Solutions}\label{sec:solutions}
  \subsubsection{Solution to \autoref{ex:unitarity}}\label{sec:solutions:unitarity}
  ...
  \subsubsection{Solution to \autoref{ex:hermitian-projectors}}\label{sec:solutions:hermitian-projectors}
