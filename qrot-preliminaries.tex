...
\subsection{A Brief Quantum Primer}
  ...
  \paragraph{General qubit states.}
    ...
    Whenever a qubit is in a state
      ...
      \abs{\alpha_b}^2$, and after observation, the superposition will have
    ...
    \[
      \ket{\psi} = \sum_{i \in [2^{n}]} \alpha_{i} \ket{x_i}\, , 
    \]
    
    \noindent
    where $\{x_i\}_{i}$ is the set of bitstrings such that the amplitude of the
